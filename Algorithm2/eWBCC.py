...
def eWBCC(partitons, precision,tradeoff):
    """
    Weight Bregmannian Consensus Clustering using Exponential Distance
    :param partitons:
    :param precision:
    :param tradeoff:
    :return:
    ...
    while delta > precision:
        ...
        last_J2 = this_J2
    # print(trend)
    # np.savetxt('eWBCC_weight_trend.txt', np.array(trend), delimiter=',')
    return Mt
